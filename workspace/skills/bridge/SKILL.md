...
Without Bridge, students treat the Uno Q like a classic Arduino and never use the Linux side. The whole point of this board is the combination.
...
When the student presses **Run** in App Lab:
