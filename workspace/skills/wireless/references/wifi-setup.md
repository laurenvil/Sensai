...
The IP address is what students need for SSH access (`ssh arduino@<ip>`) and what Telegram bots / web servers / Bridge-over-network projects bind to.
...
## Static IP (classroom deployments)
