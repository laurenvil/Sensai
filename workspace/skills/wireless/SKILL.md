...
6. **The Wi-Fi data transport is SDIO; the Bluetooth control is UART** — both internal to the QRB2210 SoC. Students don't see this; they just use Linux network APIs.
