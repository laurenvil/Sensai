# gitClasses — Pre-Seed Pitch Deck
...
**gitClasses turns every GitHub repo into a living classroom.**
...
| | **Free Classroom** | **gitClass SaaS** |
|---|---|---|
| **Branch** | `main` | `gitClass` |
...
| **gitClasses** | PR-based learning | ✅ Full | ✅ Native | ✅ Built-in | Free + SaaS |
...
2. **Course Marketplace (Phase 2)**
   - Teachers list and sell gitClasses; platform takes 15–20% revenue share
...
**Viral Loop:** Every student who completes a gitClass has a public GitHub portfolio → they share it → others discover gitClasses → network effect.
...
**Year 5:** The credentialing layer for technical hiring — employers trust gitClasses portfolios because the work is real, verified, and AI-graded.
...
**The Open Frontier, Inc.**
GitHub: https://github.com/TheOpenFrontier/gitClasses
