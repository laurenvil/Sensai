...
Extended the Sensai Classes webapp with a **teacher admin panel** and **student progress tracking** system. Teachers see a dashboard with student roster, contract approvals, and per-student deep-dives. Students see their own module progress on their dashboard.
