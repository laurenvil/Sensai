"""AutoGrader tests for Module 05 — Sensing the Environment"""
import os, re, pytest
...
def test_sketch_structure(points):
    p = os.path.join(REPO_ROOT, "curriculum-master", "modules", "module-05-sensors", "starter-code", "temp_humidity.ino")
    assert os.path.isfile(p), "temp_humidity.ino not found."
    ...
    assert "DHT" in code, "Missing DHT reference — include the DHT library."
