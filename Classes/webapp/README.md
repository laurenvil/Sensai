# Sensai Classes WebApp

A Next.js 16 multi-tenant webapp that serves as both a Udemy-style course platform and the Sensai Classes docs site. Teachers and students interact with GitHub workflows, AI, and course content through a browser UI.
...
| `NEXT_PUBLIC_GITHUB_REPO` | Repo name (default: `Sensai Classes`) |
...
The `/ai` page provides an interactive chat with the Sensai Classes AI tutor:
...
| Slug | Content |
|------|---------|
| `overview` | What Sensai Classes is and how it works |
